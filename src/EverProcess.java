...
public class Mine {
		...
		public int todayYear, todayDate, birthYear, birthMonth, birthDay, birthDate, resDate, Prior, Count = 0, Age, Sale, Price = 0;
		public int addOrder = 0, orderCount = 0;
		   ...
		   while(true) {
			...
			switch(Sale) {
				...
				if(ticketType == "A ticket") {
					...
					if(age == "Adult") {Price = 56000*95/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 44000*95/100;}
				} else {
					if(age == "Adult") {Price = 50000*95/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 40000*95/100;}
				} break;
				case 3: isEventCoupon = "10%"; 
				if(ticketType == "A ticket") {
					if(age == "Adult") {Price = 60000*90/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 48000*90/100;}
				} else if(ticketType == "B ticket") {
					if(age == "Adult") {Price = 56000*90/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 44000*90/100;}
				} else {
					if(age == "Adult") {Price = 50000*90/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 40000*90/100;}
				} break;
				case 4: isEventCoupon = "15%";
				if(ticketType == "A ticket") {
					if(age == "Adult") {Price = 60000*85/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 48000*85/100;}
				} else if(ticketType == "B ticket") {
					if(age == "Adult") {Price = 56000*85/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 44000*85/100;}
				} else {
					if(age == "Adult") {Price = 50000*85/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 40000*85/100;}
				} break;
				case 5: isEventCoupon = "30%"; 
				if(ticketType == "A ticket") {
					if(age == "Adult") {Price = 60000*70/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 48000*70/100;}
				} else if(ticketType == "B ticket") {
					if(age == "Adult") {Price = 56000*70/100;
					} else if(age == "Infant") {Price = 0;
					} else {Price = 44000*70/100;}
				} else {
					if(age == "Adult") {Price = 50000*70/100;
					} else if(age == "Infant") {Price = 0;
